...
python main.py --config=config.py:planck-2018 --config.sampling.nsamples=10000 --config.sampling.uniform_prior=True --config.sampling.fname=planck_priors_no_neutrino
